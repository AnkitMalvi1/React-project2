        ...
        <Stack direction={['column','row']}>
            ...
            <VStack w={'full'}>
                ...
                <Button variant={'link'} colorScheme='white'>
                    <a target={'blank'}href="https://youtube.com/ankmalvi22">Youtube</a>
                </Button>
                <Button variant={'link'} colorScheme='white'>
                    <a target={'blank'}href="https://instagram.com/ank.malvi">Instagram</a>
                </Button>
                <Button variant={'link'} colorScheme='white'>
                    <a target={'blank'}href="https://github.com/AnkitMalvi1">Github</a>
                </Button>
            </VStack>
        </Stack>
    </Box>
